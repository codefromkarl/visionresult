...
| User intent | Route |
|---|---|
| Wants a new feature / requirement unclear | `grill-me` |
...
Load the `grill-me` skill and explore requirements interactively with the user per the skill's guidance.

The grill-me skill will guide you to:
...
Complete prd.md via grill-me skill; then run task.py start.
